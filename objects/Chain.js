...
/**
 * TODO convert this into a reusable GameObject that accepts params
 * such as individual chain link stiffnesses and preferred directions, a sprite sheet to use, and make it render
 * as a Blitter object.
 * should also be tied into the physics system so that the base Body can be given a velocity and position, which will then contribute
 * to the solve function for constraints.
 */

export class Chain extends Phaser.GameObjects.Blitter {
  constructor() {
    super("Game");
  }
  preload() {}
